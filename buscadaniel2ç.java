...
public class buscadaniel2ç {
    ...
    public static void main(String[] args) {
        ...
        while(contador <BOMBAS){
            filaBomba = r.nextInt(FILAS);
            columnaBomba = r.nextInt(COLUMNAS);
            if (tablero[filaBomba][columnaBomba] == VACIO_SIN_VISITAR) {
        ...
        //Colocamos a DANI
        int filaDani = r.nextInt(FILAS);
        int columnaDani = r.nextInt(COLUMNAS);
        contador = 0;
        
        while(contador < 1){
            if (tablero[filaDani][columnaDani] == VACIO_SIN_VISITAR) {
                tablero[filaDani][columnaDani] = BOMBA;
                contador++;
            }
        }
        
        
        //Insertar cerca de dani
        //Fila superior
